...
\subsubsection{Full Proof for Theorem \ref{theorem-linear2zero-soft-gfq-upper-bound}}
...
\subsubsection{Proof Sketch of Theorem \ref{theorem-zero2linear-soft-gfq-upper-bound}}
...
\subsubsection{Proof Sketch of Theorem \ref{theorem-linear2linear-soft-gfq-upper-bound}}
\begin{proof}
